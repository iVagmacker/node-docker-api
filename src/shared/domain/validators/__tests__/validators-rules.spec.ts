...
describe('ValidatorRules Unit Tests', () => {
    ...
    test('maxLength validation rules', () => {
        ...
        arrange.forEach(item => {
            assertIsInvalid({ value: item.value, property: item.property, rule: 'maxLength', error: new ValidationError('The field must be less or equal than 5 characters'), params: [5] });
        });
        ...
        arrange.forEach(item => {
            assertIsValid({ value: item.value, property: item.property, rule: 'maxLength', error: new ValidationError('The field must be less or equal than 5 characters'), params: [5] });
        });
    });
