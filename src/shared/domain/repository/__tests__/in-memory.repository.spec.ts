...
describe('InMemoryRepository Unit Tests', () => {
    ...
    it('should throws error when entity not found', () => {
        ...
        expect(repository.findById('e356ad9e-d315-43cd-a69c-81a3de3a8897')).rejects.toThrow(new NotFoundError('Entity not found using ID e356ad9e-d315-43cd-a69c-81a3de3a8897'));
    });
    ...
    it('should update an entity', async () => {
        const entity = new StubEntity({ name: 'value', price: 5 });
        await repository.insert(entity);
        const entityUpdated = new StubEntity({ name: 'some value', price: 10 }, entity.uniqueEntityId);
    ...
    it('should throws erros on delete when entity not found', async () => {
        ...
        expect(repository.delete('e356ad9e-d315-43cd-a69c-81a3de3a8897')).rejects.toThrow(new NotFoundError('Entity not found using ID e356ad9e-d315-43cd-a69c-81a3de3a8897'));
    });
});