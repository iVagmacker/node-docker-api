import CategoryValidatorFactory, { CatagoryValidator, CategoryRules } from './category.validators';

describe('CategoryValidator Tests', () => {
    let validator: CatagoryValidator;
    ...
    test('valid cases for fields', () => {
        const arrange: { name: string, description?: string | null, isActive?: boolean }[] = [
            { name: "some value" },
