...
describe("ValidatorRules Unit Tests", () => {
    ...
    it("should throw a validation error when combine two or more validation rules", () => {
        ...
        expect(() => {
            validator.requiredField().string().maxLength(5);
        ...
        expect(() => {
            validator.requiredField().boolean();
        }).toThrow(new ValidationError("The field is required"));
    ...
    it("should valid when combine two or more validation rules", () => {
        expect.assertions(0);
        ValidatorRules.values("test", "field").requiredField().string();
        ValidatorRules.values("aaaaa", "field").requiredField().string().maxLength(5);

        ValidatorRules.values(true, "field").requiredField().boolean();
        ValidatorRules.values(false, "field").requiredField().boolean();
    });
});