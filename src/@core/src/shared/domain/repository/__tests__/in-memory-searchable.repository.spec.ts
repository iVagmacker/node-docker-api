...
describe('InMemorySearchableRepository Unit Tests', () => {
    ...
    describe('search method', () => {
        ...
        it('should apply paginate and sort', async () => {
            ...
            const arrange = [
                {
                    params: new SearchParams({ page: 1, perPage: 2, sort: "name" }),
                ...
                {
                    params: new SearchParams({ page: 1, perPage: 2, sort: "name", sortDir: "desc" }),
                    result: new SearchResult({
        ...
        it('should search using filter, sort and paginate', async () => {
            ...
            const arrange = [
                {
                    params: new SearchParams({ page: 1, perPage: 2, sort: "name", filter: 'TEST' }),
                    result: new SearchResult({
                ...
                {
                    params: new SearchParams({ page: 2, perPage: 2, sort: "name", filter: 'TEST' }),
                    result: new SearchResult({
                        items: [items[0]],
                        total: 3,
                        current_page: 2,
